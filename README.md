...
git clone https://github.com/H4xN3t/MsDDoS/
cd MsDDoS/
...
# Credits
```sh
Mayank-H4xN3t (Reworked CnC and added some methods .-.)
Mayank-H4xN3t (Example Panel and L7 methods <3)
Mayank-H4xN3t (Layer 7 methods <3)
Mayank-H4xN3t (Layer 7 methods <3)
Mayank-H4xN3t (Layer 4 and AMP methods <3)
Mayank-H4xN3t (Layer 4 and AMP methods <3)
Mayank-H4xN3t (LAYER 7 METHODS <3)
Mayank-H4xN3t (SPECIAL METHODS <3)
Mayank-H4xN3t (HTTP, SOCKS5, SOCK4 proxies <3)
```
